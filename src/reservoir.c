 ...
 */
int SHINE_IRAM shine_max_reservoir_bits (double *pe, shine_global_config *config )
{
 ...
 */
void SHINE_IRAM shine_ResvAdjust(gr_info *gi, shine_global_config *config )
{
 ...
 */
void SHINE_IRAM shine_ResvFrameEnd(shine_global_config *config )
{
  gr_info *gi;
