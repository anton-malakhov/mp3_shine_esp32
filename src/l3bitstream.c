...
void SHINE_IRAM shine_format_bitstream(shine_global_config *config)
{
  int gr, ch, i;
...
static void SHINE_IRAM encodeMainData(shine_global_config *config)
{
  int gr, ch, sfb;
...
static SHINE_IRAM void encodeSideInfo( shine_global_config *config )
{
...
static void SHINE_IRAM Huffmancodebits( shine_global_config *config, int *ix, gr_info *gi )
{
...
static inline int SHINE_IRAM shine_abs_and_sign( int *x )
{
  if ( *x > 0 ) return 0;
  *x *= -1;
  return 1;
...
static void SHINE_IRAM shine_huffman_coder_count1( bitstream_t *bs, const struct huffcodetab *h, int v, int w, int x, int y )
{
...
static void SHINE_IRAM shine_HuffmanCode(bitstream_t *bs, int table_select, int x, int y)
{
  int cbits = 0, xbits = 0;
